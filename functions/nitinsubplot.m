function theAxis = nitinsubplot(nrows, ncols, thisPlot, varargin)
% I modified subplot function in this script to get tight boundaries around
% the subplot. 
% Warning: Do not use this function if merging multiple panels in subplot
...
%   $Revision: 5.22.4.16 $  $Date: 2006/06/27 23:03:07 $
...
inset = [.2 .01 .01 .01]; % [left bottom right top]
...
list = [...
    addlistener(axlisth,findprop(axlisth(1),'Units'), ... % must be first
                    'PostSet',@axesUnitsPostSet);
    addlistener(axlisth,findprop(axlisth(1),'Units'), ...
                    'PreSet',@axesUnitsPreSet);
    addlistener(axlisth,findprop(axlisth(1),'Position'), ...
                    'PostSet',@axesMoved);
    addlistener(axlisth,findprop(axlisth(1),'ActivePositionProperty'), ...
                    'PreSet',@axesMoved);
    addlistener(axlisth,findprop(axlisth(1),'Parent'), ...
                    'PreSet',@axesMoved);
    addlistener(axlisth,'PropertyRemoved',@(o,e)subplotlayoutInvalid(o,e,p));
    addlistener(handle(fig),'PropertyAdded',@(o,e)subplotlayout(o,e,p))];
